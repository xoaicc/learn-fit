...
public class PC {
    ...
    public PC(@AttrRef("model") String model, @AttrRef("year") int year,
        ...
        this.comps = new Set<>();
        Vector<String> strings = comps.getElements();
    ...
    private boolean validateComps(Set<String> comps) {
        ...
        for (int i = 0; i < comps.size(); i++) {
            if (compsElements.get(i) == null || (compsElements.get(i)).length() == 0 || compsElements.get(i).equals(" ")) {
                return false;
            }
        }
        return true;
    ...
    public boolean equals(Object o) {
        ...
        PC pc = (PC) o;
        return (getYear() == pc.getYear() && Objects.equals(getModel(),
                pc.getModel()) && Objects.equals(manufacturer, pc.manufacturer) &&
