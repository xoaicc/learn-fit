...
public class CoffeeTinGame {
    ...
    private static final char[] BeansBag = new char[120];

    static {
        Arrays.fill(BeansBag, 0, 40, BLUE);
        Arrays.fill(BeansBag, 41, 80, GREEN);
        Arrays.fill(BeansBag, 81, 120, REMOVED);
    }
