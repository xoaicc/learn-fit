...
public class CoffeeTinGame {
    ...
    static {
        Arrays.fill(BeansBag, 0, 10, BLUE);
        Arrays.fill(BeansBag, 11, 20, GREEN);
        Arrays.fill(BeansBag, 21, 30, REMOVED);
    }
    ...
    public static char takeOne(char[] tin) {
        ...
        for (char bean : tin) if (bean != REMOVED) {
            count++;
        }
